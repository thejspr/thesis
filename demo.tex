%intro
This chapter demonstrates the final version of Yarn, and benchmarks it's
...
\begin{figure}[htb]
  \centering
  \includegraphics[width=0.91\textwidth]{img/yarnhelp.pdf}
...
\begin{figure}[htb]
  \centering
  \includegraphics[width=0.9\textwidth]{img/yarnserve.pdf}
